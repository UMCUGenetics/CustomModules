...
if __name__ == "__main__":
    ...
    print(
        "Total raw reads: {total:,} reads "
        "(Total throughput, 75bp={total_75bp:,} bp, 100bp={total_100bp:,} bp, 150bp={total_150bp:,} bp)".format(
            total=counts['total'],
    ...
    print(
        ...
        "(Total throughput, 75bp={total_75bp:,} bp, 100bp={total_100bp:,} bp, 150bp={total_150bp:,} bp)"
        .format(
            total=counts['mapped'],
