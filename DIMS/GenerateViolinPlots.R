...
print(scripts_dir)
print(z_score)
print(path_metabolite_groups)
print(file_ratios_metabolites)
print(file_expected_biomarkers_iem)
...
# folder for all metabolite lists (.txt)
...
# top_diseases, top_metab, output_dir ||| out: pdf file
