...
testthat::test_that("TICS are correctly accepted or rejected", {
  ...
  files_remove_tics <- list.files("./", "test_evaluate_tics_file", full.names = TRUE)
  files_remove_miss <- list.files("./", "miss_infusions_", full.names = TRUE)
  files_remove <- c(files_remove_tics, files_remove_miss)
